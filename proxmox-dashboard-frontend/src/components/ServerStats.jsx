...
const StatCard = ({ icon: Icon, label, value, unit, trend }) => (
  <div className="relative group">
    {/* Glow effect externe */}
    <div className="absolute -inset-1 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
